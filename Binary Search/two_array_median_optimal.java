...
import java.util.*;
public class two_array_median_optimal
{
    ...
    public static double search(int [] arr1, int arr2[], int n1, int n2)
    {
        if(n1 > n2)
        {
            return (search(arr2,arr1,n2,n1));
        }
        int low = 0;
        int high = n1;
        int left = (n1 + n2 + 1) / 2;
    ...
    public static void main(String[] args)
    {
        ...
        double ans = search(arr1,arr2,n1,n2);
